...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--iteration1', type=int, default=2, help="enumerate iteration in preprocessing stage")
    # 预处理阶段迭代次数
    parser.add_argument('--rounds1', type=int, default=100, help="rounds of training in fine_tuning stage")
    # 微调阶段迭代轮数
    parser.add_argument('--rounds2', type=int, default=100, help="rounds of training in usual training stage")
    # 常规训练阶段迭代轮数
    parser.add_argument('--local_ep', type=int, default=5, help="number of local epochs")
    # 本地训练epoch数
    parser.add_argument('--frac1', type=float, default=0.02, help="fration of selected clients in preprocessing stage")
    # 预处理阶段选择客户端的几率
